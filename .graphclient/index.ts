...
export type ResolversTypes = ResolversObject<{
  ...
  secreth_cipher: ResolverTypeWrapper<secreth_cipher>;
  secreth_cipher_filter: secreth_cipher_filter;
  secreth_cipher_orderBy: secreth_cipher_orderBy;
}>;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  secrethCipher?: Resolver<Maybe<ResolversTypes['secreth_cipher']>, ParentType, ContextType, RequireFields<QuerysecrethCipherArgs, 'id' | 'subgraphError'>>;
  secrethCiphers?: Resolver<Array<ResolversTypes['secreth_cipher']>, ParentType, ContextType, RequireFields<QuerysecrethCiphersArgs, 'skip' | 'first' | 'subgraphError'>>;
  _meta?: Resolver<Maybe<ResolversTypes['_Meta_']>, ParentType, ContextType, Partial<Query_metaArgs>>;
}>;

export type SubscriptionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  secrethCipher?: SubscriptionResolver<Maybe<ResolversTypes['secreth_cipher']>, "secrethCipher", ParentType, ContextType, RequireFields<SubscriptionsecrethCipherArgs, 'id' | 'subgraphError'>>;
  secrethCiphers?: SubscriptionResolver<Array<ResolversTypes['secreth_cipher']>, "secrethCiphers", ParentType, ContextType, RequireFields<SubscriptionsecrethCiphersArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export type secreth_cipherResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['secreth_cipher'] = ResolversParentTypes['secreth_cipher']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  cipher?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type Resolvers<ContextType = MeshContext> = ResolversObject<{
  ...
  secreth_cipher?: secreth_cipherResolvers<ContextType>;
}>;
...
const uniswapv2Handler = new GraphqlHandler({
              name: "uniswapv2",
              config: {"endpoint":"https://api.studio.thegraph.com/query/37633/secreth_goerli_subgraph/0.420.69"},
              baseDir,
              cache,
              pubsub,
